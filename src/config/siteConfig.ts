...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "King's Tech Blog",

	// 站点 URL
	site_url: "https://blog.kinghua0639.com",

	// 站点描述
	description:
		"King's Tech Blog is a personal blog that shares technical articles, tutorials, and insights on web development, programming, and technology trends.",
